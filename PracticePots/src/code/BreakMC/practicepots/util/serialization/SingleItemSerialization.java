...
public class SingleItemSerialization {
	...
	/**
	 * Serialize an ItemStack that is inside an inventory. An extra "index" key
	 * will be added to store the position of the ItemStack in the inventory
	 * 
	 * @param items
	 *            The items to serialize
	 * @param index
	 *            The position of the ItemStack inside the inventory
	...
	/**
	 * Deserialize an ItemStack. An index if given strictly for debug purposes.
	 * When an error message is given the index will be used for more useful
	 * reference
	 * 
	 * @param item
	 *            The ItemStack to deserialize
	 * @param index
	 *            The index of the ItemStack in an inventory or ItemStack array
	 * @return The deserialized ItemStack
	 */
