package code.BreakMC.practicepots.util.serialization;
...
/**
 * A class to help with the serialization of Enchantments. Because of the
 * ability to add unsafe enchantments (item and enchantment level are ignored),
 * enchantments are serialized in a different way than like ChestShop. ChestShop
 * takes the enchantment id, converts it into a String, and appends the level.
 * It then iterates this process for each enchantment. Afterwards, it has a very
 * long number, which it then conveters to a base-32 String. <br/>
 * <br/>
 * This class serializes it much differently, and it is in fact more human
 * readable. The process can be explained as such:
 * 
 * <pre>
 ...
 * </pre>
 * 
 * This allows for much easier readability as well as the possibility to
 * unsafely add enchantments
 * 
 * @author KILL3RTACO
 * @since 1.0
 *
...
public class EnchantmentSerialization {
	...
	/**
	 * Serialize a Map of Enchantments and their levels into a string that
	 * follows the regex
	 * 
	 * <pre>
	 * ([0-9]+:[0-9]+;)+
	...
	/**
	 * Get a Map of Enchantments and their levels from an enchantment
	 * serialization string
	 * 
	 * @param serializedEnchants
	 *            The serialization string to decode
	 ...
	 * 
	 * @param oldFormat
	 *            The old (ChestShop compatible) enchantment code.
	 * @return A map of enchantments and their levels using the old (ChestShop
	 *         compatible) enchantment code.
	 */
	...
	/**
	 * Convert to the old (ChestShop compatible) enchantment code to a more
	 * friendly format
	 * 
	 * @param oldFormat
	...
	/**
	 * Convert an old base-32 string into a map of enchantments and return the
	 * enchantments.
	 * 
	 * @param oldFormat
	 *            The old (ChestShop compatible) enchantment code to use
	...
	/**
	 * Apply Enchantments to an ItemStack using a Enchantment serialization
	 * string
	 * 
	 * @param code
	 *            The enchantment code to use
	 * @param items
	 *            The items to apply the enchantments to
	 */
