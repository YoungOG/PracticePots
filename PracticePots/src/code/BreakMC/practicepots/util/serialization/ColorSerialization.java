...
/**
 * A class to help with the serialilzation of Colors. Note that the Color class
 * used is Bukkit's org.bukkit.Color, to provide support to create a color using
 * BGR <i>and</i> RGB formats.
 * 
 * You can convert a org.bukkit.Color to a java.awt.Color by doing the
 * following:
 * 
 * <pre>
 * org.bukkit.Color testColor = new org.bukkit.Color.fromRGB(255, 255, 0); // yellow
 * jawa.awt.Color converted = new java.awt.Color(testColor.asRGB()); // asBGR()
 * // will not
 * // work, as
 * // java.awt.Color
 * // uses the
...
public class ColorSerialization {
	...
	/**
	 * Serialize a Color into JSONObject form. Colors are serialized into a
	 * JSONObject with red, green, and blue as keys
	 * 
	 * @param color
	...
	/**
	 * Get a Color from a JSONObject. If any one of the red, green, or blue keys
	 * are not found, they are given a value of 0 by default. Therefore, if the
	 * red and green values found were both 0, and the blue key is not found,
	 * the resulting color is black (0, 0, 0).
	 * 
	 * @param color
	 ...
	 *            Whether the resulting string should be 'pretty' or not
	 * @param indentFactor
	 *            The amount of spaces to use for a tab
	 * @return The serialization string
	 */
