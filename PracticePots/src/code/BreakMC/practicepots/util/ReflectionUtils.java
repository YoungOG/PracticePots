...
public final class ReflectionUtils {
	...
	/**
	 * Represents an enumeration of all packet types that are featured in
	 * <b>Minecraft 1.7.10</b>
	 * <p>
	 * If this enumeration is no longer up-to-date, please let me know in my <a
	 * href
	...
	public enum PacketType {
		 ...
		 * @throws ClassNotFoundException
		 *             If the packet class cannot be found (the name differs in
		 *             your Bukkit version)
		 * 
		 */
