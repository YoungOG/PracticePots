...
import code.BreakMC.practicepots.util.ReflectionUtils.PackageType;
import code.BreakMC.practicepots.util.ReflectionUtils.PacketType;

/**
 * <b>ParticleEffect Library</b>
 * <p>
 * This library was created by @DarkBlade12 based on content related to
 * particles of @microgeek (names and packet parameters), it allows you to
 * display all Minecraft particle effects on a Bukkit server
 * <p>
...
public enum ParticleEffect {
	 ...
	 * @param range
	 *            Range of the visibility (Maximum range for particles is
	 ...
	 *            usually 16, but it can differ for some types)
	 * @throws IllegalArgumentException
	 *             If the specified id is not a block id
	 * @see ParticleEffectPacket
	 * @see ParticleEffectPacket#sendTo(Location, double)
	 */
	...
	public static final class ParticleEffectPacket {
		 ...
		 *             if accessed packets, fields or methods differ in your
		 *             bukkit version
		 */
